...
* lazy-flashcard:getByIdFunction (nodejs12.x)
* API lazy-flashcard:getByIdFunction (nodejs12.x)
* lazy-flashcard:putItemFunction (nodejs12.x)
* API lazy-flashcard:putItemFunction (nodejs12.x)
* lazy-flashcard:SampleTable
